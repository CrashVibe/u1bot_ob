        ...
        <div class="quick-item">
          ...
          >
            <path
              ...
              fill="currentColor"
            ></path>
            <path d="M20 22a4 4 0 0 0-8 0h2a2 2 0 1 1 2 2H8v2h8a4.005 4.005 0 0 0 4-4z" fill="currentColor"></path>
            <path d="M26 22a4.005 4.005 0 0 0-4 4h2a2 2 0 1 1 2 2H12v2h14a4 4 0 0 0 0-8z" fill="currentColor"></path>
          </svg>
    ...
    <div v-if="airQualityData && airPollutantData" class="glass-card air-pollutants">
      ...
      <div class="pollutants-grid-detailed">
        <div class="pollutant-detail">
          ...
          <span class="pollutant-value">{{ airPollutantData.pm2p5 !== undefined ? airPollutantData.pm2p5 : "-" }}</span>
          <div class="pollutant-bar">
            <div
              class="pollutant-fill"
              :style="{
                width:
                  (airPollutantData.pm2p5 !== undefined ? Math.min((airPollutantData.pm2p5 / 150) * 100, 100) : 0) + '%'
              }"
            ></div>
          </div>
        </div>
        <div class="pollutant-detail">
          ...
          <span class="pollutant-value">{{ airPollutantData.pm10 !== undefined ? airPollutantData.pm10 : "-" }}</span>
          <div class="pollutant-bar">
            <div
              class="pollutant-fill"
              :style="{
                width:
                  (airPollutantData.pm10 !== undefined ? Math.min((airPollutantData.pm10 / 250) * 100, 100) : 0) + '%'
              }"
            ></div>
          </div>
        </div>
        <div class="pollutant-detail">
          ...
          <span class="pollutant-value">{{ airPollutantData.o3 !== undefined ? airPollutantData.o3 : "-" }}</span>
          <div class="pollutant-bar">
            <div
              class="pollutant-fill"
              :style="{
                width: (airPollutantData.o3 !== undefined ? Math.min((airPollutantData.o3 / 200) * 100, 100) : 0) + '%'
              }"
            ></div>
          </div>
        </div>
        <div class="pollutant-detail">
          ...
          <span class="pollutant-value">{{ airPollutantData.no2 !== undefined ? airPollutantData.no2 : "-" }}</span>
          <div class="pollutant-bar">
            <div
              class="pollutant-fill"
              :style="{
                width:
                  (airPollutantData.no2 !== undefined ? Math.min((airPollutantData.no2 / 100) * 100, 100) : 0) + '%'
              }"
            ></div>
          </div>
        </div>
        <div class="pollutant-detail">
          ...
          <span class="pollutant-value">{{ airPollutantData.so2 !== undefined ? airPollutantData.so2 : "-" }}</span>
          <div class="pollutant-bar">
            <div
              class="pollutant-fill"
              :style="{
                width:
                  (airPollutantData.so2 !== undefined ? Math.min((airPollutantData.so2 / 150) * 100, 100) : 0) + '%'
              }"
            ></div>
          </div>
        </div>
        <div class="pollutant-detail">
          ...
          <span class="pollutant-value">{{ airPollutantData.co !== undefined ? airPollutantData.co : "-" }}</span>
          <div class="pollutant-bar">
            <div
              class="pollutant-fill"
              :style="{
                width: (airPollutantData.co !== undefined ? Math.min((airPollutantData.co / 4) * 100, 100) : 0) + '%'
              }"
            ></div>
          </div>
        </div>
